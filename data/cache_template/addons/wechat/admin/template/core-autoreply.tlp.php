...
<head>
	...
	<!--[if lt IE 9]>
		<script src="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>statics/html5.js"></script>
	<![endif]-->
	<script src="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>statics/jquery/jquery-1.12.2.min.js" language="javascript"></script>
    <script src="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>statics/reveal/jquery.reveal.js" language="javascript"></script>
    <script src="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>statics/BlocksIt/blocksit.min.js"></script>
	...
	<style type="text/css">
		...
		.si-editor .si-content .si-add-a{ background:url(<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>addons/wechat/admin/template/images/tuwen_editor_add.png) center center no-repeat; color:#999;width:150px;text-align:center;height:0px; padding-top:30px; line-height:2em; display:block; margin:0px auto; margin-top:100px;}
		...
		background:url("<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>addons/wechat/admin/template/images/voice.gif"); width:60px; height:60px; margin:10px; float:left}
...
<body>
    <div class="ifame-main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?file=index&action=main">管理首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">自动回复</span></div>
        </div>
        <div class="result-wrap">
            <form action="" method="post" name="mysubmitform" id="mysubmitform" enctype="multipart/form-data">
            	<input type="hidden" value="1" name="dosubmit">
                <input type="hidden" value="<?php echo isset($PW['wechat_auto_msg_type'])?$PW['wechat_auto_msg_type']:'';?>" name="config[wechat_auto_msg_type]" id="wechat_auto_msg_type">
                <input type="hidden" value="<?php echo isset($PW['wechat_auto_msg_value'])?$PW['wechat_auto_msg_value']:'';?>" name="config[wechat_auto_msg_value]" id="wechat_auto_msg_value">
                <div class="config-items">     
					<div class="admin-nav">
                        ...
                        <div class="nav">
                            ...
                            <a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=core&action=autoreply" class="hover">消息自动回复</a>
                            <a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=core&action=helpreply">关键词自动回复</a>
                        </div>
                    ...
                    <div class="si-editor">
                    	<div class="si-title">
                        	<a href="javascript:void(0);" id="title_media" onClick="toggle_msg_type('media');" <?php if($PW['wechat_auto_msg_type']=='media') { ?>class="hover"<?php }?>><i class="icon-font">&#xe033;</i>图文消息</a> 
                            <a href="javascript:void(0);" id="title_text" onClick="toggle_msg_type('text');" <?php if($PW['wechat_auto_msg_type']=='text') { ?>class="hover"<?php }?>><i class="icon-font">&#xe002;</i>文字</a> 
                            <a href="javascript:void(0);" id="title_image" onClick="toggle_msg_type('image');" <?php if($PW['wechat_auto_msg_type']=='image') { ?>class="hover"<?php }?>><i class="icon-font">&#xe029;</i>图片</a> 
                            <a href="javascript:void(0);" id="title_voice" onClick="toggle_msg_type('voice');" <?php if($PW['wechat_auto_msg_type']=='voice') { ?>class="hover"<?php }?>><i class="icon-font">&#xe035;</i>语音</a>  
                            <a href="javascript:void(0);" id="title_video" onClick="toggle_msg_type('video');" <?php if($PW['wechat_auto_msg_type']=='video') { ?>class="hover"<?php }?>><i class="icon-font">&#xe044;</i>视频</a>
                        </div>
                        <?php $mediainfo=WeChatManage::getMaterialByMediaId($PW['wechat_auto_msg_value']);?>
                        
                        <div class="si-content" id="material-dialog-media"<?php if($PW['wechat_auto_msg_type']!='media') { ?> style="display:none"<?php }?>>
                       		<?php if($mediainfo  && $PW['wechat_auto_msg_type']=='media'){?>
                            <?php $c=WeChatManage::getMutiMaterial($mediainfo['id']);?>
                            <div class="material-list">
                                <ul>
                                	<?php if($c) { ?>
                                    <li data-reveal-id="material-dialog"  data-animation="fade">
                                        <div class="title"><?php echo date('Y年m月d日',$mediainfo['UpdateTime']);?></div>
                                        <div class="appmsg_thumb_wrp" style="background-image:url('<?php echo format_url($mediainfo['PicUrl']);?>')"><span><?php echo isset($mediainfo['Title'])?$mediainfo['Title']:'';?></span></div>
                                    ...
                                    <?php }else{ ?>
                                    <li  data-reveal-id="material-dialog"  data-animation="fade">
                                        <div class="date"><?php echo date('m月d日',$mediainfo['UpdateTime']);?></div>
                                        <div class="title"><?php echo isset($mediainfo['Title'])?$mediainfo['Title']:'';?></div>
                                        <div class="appmsg_thumb_wrp" style="background-image:url('<?php echo format_url($mediainfo['PicUrl']);?>')"></div>
                                        <div class="desc"><?php echo isset($mediainfo['Description'])?$mediainfo['Description']:'';?></div>
                                    </li>
                                    <?php }?>
                                </ul>
                            </div>
                            ...
                            <div class="si-add-right">
                            	<a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=material_post" class="si-add-a">新建图文消息</a>
                            </div>
                            <?php }?>
                        </div>
                        <div class="si-content" id="material-dialog-text"<?php if($PW['wechat_auto_msg_type']!='text') { ?> style="display:none"<?php }?>>
                        	<textarea cols="55" rows="6" id="wechat_auto_msg_text" style="width:850px; height:250px; border:0px; font-family:'Microsoft YaHei';overflow:auto;resize:none; background:none" name="config[wechat_auto_msg_text]"><?php echo isset($PW['wechat_auto_msg_text'])?$PW['wechat_auto_msg_text']:'';?></textarea>
                            <br>
                            <span id="emoji" onClick="$('#emojidiv').toggle();"><i class="icon-font">&#xe038;</i> 添加表情
							<div class="emojidiv" id="emojidiv">
								<ul>
									<?php $no=1;if(is_array(WeChatManage::getEmojiList()))foreach(WeChatManage::getEmojiList() as $r){?>
									<li onClick="$('#wechat_auto_msg_text').insertContent('[<?php echo isset($r['emoji'])?$r['emoji']:'';?>]'); "><img src="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>addons/wechat/admin/template/images/emoji/<?php echo isset($r['emoji'])?$r['emoji']:'';?>.png"></li>
									<?php $no++;}?>
								</ul>
							</div>
							</span>
                        </div>
                        <?php $imageinfo=WeChatManage::getImageMaterialByMediaId($PW['wechat_auto_msg_value']);?>
                        <div class="si-content" id="material-dialog-image"<?php if($PW['wechat_auto_msg_type']!='image') { ?> style="display:none"<?php }?>>
                        	<?php if($imageinfo  && $PW['wechat_auto_msg_type']=='image'){?>
                            <div class=material-list>
                            	<ul>
                                	<li style="width:160px;" data-reveal-id="image-material-dialog"  data-animation="fade">
                                    <img src="<?php echo format_url($imageinfo['local_url']);?>" style="width:155px; height:152px" />
                                    </li>
                                </ul>
                           	</div>
                            <?php }else{?>
                            ...
                            <div class="si-add-right">
                            	<a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=material_image" class="si-add-a">新建图片消息</a>
                            </div>
                            <?php }?>
                        </div>
                        <?php $voiceinfo=WeChatManage::getVoiceMaterialByMediaId($PW['wechat_auto_msg_value']);?>
                        <div class="si-content" id="material-dialog-voice"<?php if($PW['wechat_auto_msg_type']!='voice') { ?> style="display:none"<?php }?>>
                        	<?php if($voiceinfo  && $PW['wechat_auto_msg_type']=='voice'){?>
                            <div class=material-list>
                            	<ul>
                                	<li data-reveal-id="voice-material-dialog"  data-animation="fade">
                                        <div class="date"><?php echo date('m月d日',$voiceinfo['created_at']);?></div>
                                        <div class="appmsg_thumb_wrp" style="height:80px;">
                                            <div class="left-div"></div>
                                            <div class="right-div"><?php echo isset($voiceinfo['name'])?$voiceinfo['name']:'';?></div>
                                        </div>
                                    </li>
                                </ul>
                           	</div>
                            ...
                            <div class="si-add-right">
                            	<a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=material_voice" class="si-add-a">新建语音消息</a>
                            </div>
                            <?php }?>
                        </div>
                        <?php $videoinfo=WeChatManage::getVideoMaterialByMediaId($PW['wechat_auto_msg_value']);?>
                        <div class="si-content" id="material-dialog-video"<?php if($PW['wechat_auto_msg_type']!='video') { ?> style="display:none"<?php }?>>
                        	<?php if($videoinfo  && $PW['wechat_auto_msg_type']=='video'){?>
                            <div class=material-list>
                            	<ul>
                                	<li data-reveal-id="video-material-dialog"  data-animation="fade">
                                        <div class="title"><?php echo date('Y年m月d日',$videoinfo['created_at']);?></div>
                    					<div class="appmsg_thumb_wrp" style="background-image:url('<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>addons/wechat/admin/template/images/video.gif');background-size: inherit;"><span><a href="<?php echo isset($videoinfo['remote_url'])?$videoinfo['remote_url']:'';?>" target="_blank"><?php echo isset($videoinfo['name'])?$videoinfo['name']:'';?></a></span></div>
                                    </li>
                                </ul>
                           	</div>
                            <?php }else{?>
                            ...
                            <div class="si-add-right">
                            	<a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=material_video" class="si-add-a">新建视频消息</a>
                            </div>
                            <?php }?>
                        </div>
                        <div class="si-btn">
    ...
    <div id="material-dialog" class="reveal-modal" style="width:95%;  left:320px">
        ...
        <div class="material-list" style=" height:520px; overflow:auto">
            <ul id="container">
                ...
                $('#wechat_auto_msg_value').val('<?php echo $r['media_id'];?>');$('.close-reveal-modal').click();">
     ...
     <div id="image-material-dialog" class="reveal-modal" style="width:95%;  left:320px">
        ...
        <div class="material-list" style=" height:520px; overflow:auto">
            <ul>
            	<?php $no=1;if(is_array(WeChatManage::imageMaterialJqueryList(1,100)))foreach(WeChatManage::imageMaterialJqueryList(1,100) as $r){?>
                ...
                $('#wechat_auto_msg_value').val('<?php echo $r['media_id'];?>');$('.close-reveal-modal').click();"><img src="<?php echo format_url($r['local_url']);?>" style="width:155px; height:152px" /></li>
				<?php $no++;}?>
            </ul>
        </div>
        <a class="close-reveal-modal">&#215;</a>
     ...
     <div id="voice-material-dialog" class="reveal-modal" style="width:95%;  left:320px">
        ...
        <div class="material-list" style=" height:520px; overflow:auto">
            <ul>
            	<?php $no=1;if(is_array(WeChatManage::voiceMaterialJqueryList(1,100)))foreach(WeChatManage::voiceMaterialJqueryList(1,100) as $r){?>
                ...
                $('#wechat_auto_msg_value').val('<?php echo $r['media_id'];?>');$('.close-reveal-modal').click();">
					<div class="date"><?php echo date('m月d日',$r['created_at']);?></div>
					<div class="appmsg_thumb_wrp" style="height:80px;">
						<div class="left-div"></div>
						<div class="right-div"><?php echo isset($r['name'])?$r['name']:'';?></div>
					</div>
				</li>
				<?php $no++;}?>
            </ul>
     ...
     <div id="video-material-dialog" class="reveal-modal" style="width:95%;  left:320px">
        ...
        <div class="material-list" style=" height:520px; overflow:auto">
            <ul>
            	<?php $no=1;if(is_array(WeChatManage::videoMaterialJqueryList(1,100)))foreach(WeChatManage::videoMaterialJqueryList(1,100) as $r){?>
                ...
                $('#wechat_auto_msg_value').val('<?php echo $r['media_id'];?>');$('.close-reveal-modal').click();">
					<div class="title"><?php echo date('Y年m月d日',$r['created_at']);?></div>
                    <div class="appmsg_thumb_wrp" style="background-image:url('<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>addons/wechat/admin/template/images/video.gif');background-size: inherit;"><span><a href="<?php echo isset($r['remote_url'])?$r['remote_url']:'';?>" target="_blank"><?php echo isset($r['name'])?$r['name']:'';?></a></span></div>
				</li>
				<?php $no++;}?>
            </ul>
        </div>
