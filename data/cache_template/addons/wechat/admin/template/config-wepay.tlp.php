...
<body>
    <div class="ifame-main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?file=index&action=main">管理首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">微信支付配置</span></div>
        </div>
        ...
        <div class="result-wrap">
			<div class="config-items">
				<div class="admin-nav">
                        <h2>微信支付配置</h2>
                        <div class="nav">
                            <a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=wepay" class="hover">微信支付配置</a>
                        </div>
                    </div>
					...
					<table width="100%" class="insert-tab">
						<tbody>
							...
							<tr class="formtr">
								...
								<td class="formtd"><input type="text" value="<?php echo isset($PW['wechat_paysignkey'])?$PW['wechat_paysignkey']:'';?>" size="65" name="info[wechat_paysignkey]" class="common-text"></td>
							</tr>
							<tr class="formtr">
								<th class="formth"><i class="require-red">*</i>微信支付商户号：</th>
								<td class="formtd"><input type="text" value="<?php echo isset($PW['wechat_mchid'])?$PW['wechat_mchid']:'';?>" size="65" name="info[wechat_mchid]" class="common-text"></td>
							</tr>
							<tr class="formtr">
