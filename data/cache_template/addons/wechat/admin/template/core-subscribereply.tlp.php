    ...
    <div class="ifame-main-wrap">
        ...
        <div class="result-wrap">
            <form action="" method="post" name="mysubmitform" id="mysubmitform" enctype="multipart/form-data">
                ...
                <input type="hidden" value="<?php echo isset($PW['wechat_subscribe_msg_type'])?$PW['wechat_subscribe_msg_type']:'';?>" name="config[wechat_subscribe_msg_type]" id="wechat_subscribe_msg_type">
                <input type="hidden" value="<?php echo isset($PW['wechat_subscribe_msg_value'])?$PW['wechat_subscribe_msg_value']:'';?>" name="config[wechat_subscribe_msg_value]" id="wechat_subscribe_msg_value">
                <div class="config-items">     
					<div class="admin-nav">
                        <h2>自动回复</h2>
                        <div class="nav">
                            <a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=core&action=subscribereply" class="hover">被关注自动回复</a>
                        ...
                        <div class="admin-tips">
                        	被关注自动回复是指当有用户关注您的公众号时，第一时间的自动回复内容。
                        </div>
                    </div>
                    <div class="si-editor">
                    	<div class="si-title">
                        	<a href="javascript:void(0);" id="title_media" onClick="toggle_msg_type('media');" <?php if($PW['wechat_subscribe_msg_type']=='media') { ?>class="hover"<?php }?>><i class="icon-font">&#xe033;</i>图文消息</a> 
                            <a href="javascript:void(0);" id="title_text" onClick="toggle_msg_type('text');" <?php if($PW['wechat_subscribe_msg_type']=='text') { ?>class="hover"<?php }?>><i class="icon-font">&#xe002;</i>文字</a> 
                        ...
                        <?php $mediainfo=WeChatManage::getMaterialByMediaId($PW['wechat_subscribe_msg_value']);?>
                        
                        <div class="si-content" id="material-dialog-media"<?php if($PW['wechat_subscribe_msg_type']!='media') { ?> style="display:none"<?php }?>>
                       		<?php if($mediainfo  && $PW['wechat_subscribe_msg_type']=='media'){?>
                        ...
                        <div class="si-content" id="material-dialog-text"<?php if($PW['wechat_subscribe_msg_type']!='text') { ?> style="display:none"<?php }?>>
                        	<textarea cols="55" rows="6" id="wechat_subscribe_msg_text" style="width:850px; height:250px; border:0px; font-family:'Microsoft YaHei';overflow:auto;resize:none; background:none" name="config[wechat_subscribe_msg_text]"><?php echo isset($PW['wechat_subscribe_msg_text'])?$PW['wechat_subscribe_msg_text']:'';?></textarea>
                            <br>
							...
							<div class="emojidiv" id="emojidiv">
								<ul>
									...
									<li onClick="$('#wechat_subscribe_msg_text').insertContent('[<?php echo isset($r['emoji'])?$r['emoji']:'';?>]'); "><img src="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>addons/wechat/admin/template/images/emoji/<?php echo isset($r['emoji'])?$r['emoji']:'';?>.png"></li>
									<?php $no++;}?>
								</ul>
							</div>
							</span>
                        </div>
                        <?php $imageinfo=WeChatManage::getImageMaterialByMediaId($PW['wechat_subscribe_msg_value']);?>
                        <div class="si-content" id="material-dialog-image"<?php if($PW['wechat_subscribe_msg_type']!='image') { ?> style="display:none"<?php }?>>
                        	<?php if($imageinfo  && $PW['wechat_subscribe_msg_type']=='image'){?>
                            <div class=material-list>
                            	<ul>
                        ...
                        <?php $voiceinfo=WeChatManage::getVoiceMaterialByMediaId($PW['wechat_subscribe_msg_value']);?>
                        <div class="si-content" id="material-dialog-voice"<?php if($PW['wechat_subscribe_msg_type']!='voice') { ?> style="display:none"<?php }?>>
                        	<?php if($voiceinfo  && $PW['wechat_subscribe_msg_type']=='voice'){?>
                            <div class=material-list>
                            	<ul>
                        ...
                        <?php $videoinfo=WeChatManage::getVideoMaterialByMediaId($PW['wechat_subscribe_msg_value']);?>
                        <div class="si-content" id="material-dialog-video"<?php if($PW['wechat_subscribe_msg_type']!='video') { ?> style="display:none"<?php }?>>
                        	<?php if($videoinfo  && $PW['wechat_subscribe_msg_type']=='video'){?>
                            <div class=material-list>
                            	<ul>
    ...
    <div id="material-dialog" class="reveal-modal" style="width:95%;  left:320px">
        ...
        <div class="material-list" style=" height:520px; overflow:auto">
            <ul id="container">
                ...
                $('#wechat_subscribe_msg_value').val('<?php echo $r['media_id'];?>');$('.close-reveal-modal').click();">
     ...
     <div id="image-material-dialog" class="reveal-modal" style="width:95%;  left:320px">
        ...
        <div class="material-list" style=" height:520px; overflow:auto">
            <ul>
                ...
                $('#wechat_subscribe_msg_value').val('<?php echo $r['media_id'];?>');$('.close-reveal-modal').click();"><img src="<?php echo format_url($r['local_url']);?>" style="width:155px; height:152px" /></li>
				<?php $no++;}?>
            </ul>
        </div>
        <a class="close-reveal-modal">&#215;</a>
