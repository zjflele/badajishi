...
<head>
	...
	<style type="text/css">
		.si-editor{ border:1px solid #F3F3F3;height: auto;overflow: auto;}
    ...
    <div class="ifame-main-wrap">
        ...
        <div class="result-wrap">
            <form action="" method="post" name="mysubmitform" id="mysubmitform" enctype="multipart/form-data">
                ...
                <input type="hidden" value="<?php echo isset($PW['wechat_help_msg_type'])?$PW['wechat_help_msg_type']:'';?>" name="config[wechat_help_msg_type]" id="wechat_help_msg_type">
                <input type="hidden" name="info[media_id]" value="" id="media_id">
                <div class="config-items">     
                    ...
                    <div class="si-editor">
                    	<div class="si-title">
                        	<a href="javascript:void(0);" id="title_media" onClick="toggle_msg_type('media');" <?php if($PW['wechat_help_msg_type']=='media') { ?>class="hover"<?php }?>><i class="icon-font">&#xe033;</i>图文消息</a> 
                            <a href="javascript:void(0);" id="title_text" onClick="toggle_msg_type('text');" <?php if($PW['wechat_help_msg_type']=='text') { ?>class="hover"<?php }?>><i class="icon-font">&#xe002;</i>文字</a> 
                            <a href="javascript:void(0);" id="title_image" onClick="toggle_msg_type('image');" <?php if($PW['wechat_help_msg_type']=='image') { ?>class="hover"<?php }?>><i class="icon-font">&#xe029;</i>图片</a> 
                            <a href="javascript:void(0);" id="title_voice" onClick="toggle_msg_type('voice');" <?php if($PW['wechat_help_msg_type']=='voice') { ?>class="hover"<?php }?>><i class="icon-font">&#xe035;</i>语音</a>  
                            <a href="javascript:void(0);" id="title_video" onClick="toggle_msg_type('video');" <?php if($PW['wechat_help_msg_type']=='video') { ?>class="hover"<?php }?>><i class="icon-font">&#xe044;</i>视频</a>
                        </div>
                        
						<div class="si-content" id="material-dialog-media"<?php if($PW['wechat_help_msg_type']!='media') { ?> style="display:none"<?php }?>>
                        ...
                        <div class="si-content" id="material-dialog-text"<?php if($PW['wechat_help_msg_type']!='text') { ?> style="display:none"<?php }?>>
                        	<textarea cols="55" rows="6" id="wechat_help_msg_text" style="width:850px; height:250px; border:0px; font-family:'Microsoft YaHei';overflow:auto;resize:none; background:none" name="config[wechat_help_msg_text]"></textarea>
                            <br>
							...
							<div class="emojidiv" id="emojidiv">
								<ul>
									...
									<li onClick="$('#wechat_help_msg_text').insertContent('[<?php echo isset($r['emoji'])?$r['emoji']:'';?>]'); "><img src="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>addons/wechat/admin/template/images/emoji/<?php echo isset($r['emoji'])?$r['emoji']:'';?>.png"></li>
									<?php $no++;}?>
								</ul>
							</div>
							</span>
                        ...
                        <div class="si-content" id="material-dialog-image"<?php if($PW['wechat_help_msg_type']!='image') { ?> style="display:none"<?php }?>>
                       		<div class="si-add-left">
                        ...
                        <div class="si-content" id="material-dialog-voice"<?php if($PW['wechat_help_msg_type']!='voice') { ?> style="display:none"<?php }?>>
                       		<div class="si-add-left">
                        ...
                        <div class="si-content" id="material-dialog-video"<?php if($PW['wechat_help_msg_type']!='video') { ?> style="display:none"<?php }?>>
                       		<div class="si-add-left">
                        ...
                        <p>
                        匹配模式：
                        <label><input type="radio" value="1" checked name="info[keyword_type]" class="common-radio">精确匹配</label>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <label><input type="radio" value="0" name="info[keyword_type]" class="common-radio">模糊匹配</label>
                        </p>
                        <p>
                        关键词：<input type="text" size="64" name="info[keyword]" class="common-text">
                        </p>
                        <p>
    ...
    <div id="material-dialog" class="reveal-modal" style="width:95%;  left:320px">
        ...
        <div class="material-list" style=" height:520px; overflow:auto">
            <ul id="container">
                ...
                $('#media_id').val('<?php echo $r['media_id'];?>');$('.close-reveal-modal').click();">
     ...
     <div id="image-material-dialog" class="reveal-modal" style="width:95%;  left:320px">
        ...
        <div class="material-list" style=" height:520px; overflow:auto">
            <ul>
                ...
                $('#media_id').val('<?php echo $r['media_id'];?>');$('.close-reveal-modal').click();"><img src="<?php echo format_url($r['local_url']);?>" style="width:155px; height:152px" /></li>
				<?php $no++;}?>
            </ul>
        </div>
        <a class="close-reveal-modal">&#215;</a>
