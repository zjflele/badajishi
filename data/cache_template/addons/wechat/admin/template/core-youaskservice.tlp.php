      ...
      <div class="result-wrap">
          <form name="myform" id="myform" action="" method="post">
              ...
              <div class="admin-nav">
                <h2>客服功能</h2>
                <div class="nav">
                    <a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=core&action=youaskservice" class="hover">全部客服</a>
                    <a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=core&action=youaskservice_onlie">在线客服</a>
                    <a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=core&action=youaskservice_add">添加客服</a>
                </div>
              ...
              <div class="btn-post">
				<a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=core&action=youaskservice_synchronism" class="a-btn-post" ><i class="icon-font">&#xe025;</i> 同步微信客服</a>
			  </div>
              <div class="result-content">
                  <table class="result-tab" width="100%">
                      ...
                      <tr>
                          ...
                          <td>
                          <?php echo isset($r['kf_account'])?$r['kf_account']:'';?>
                          </td>
                          <td><?php echo isset($r['kf_nick'])?$r['kf_nick']:'';?></td>
						  <td><?php echo isset($r['kf_id'])?$r['kf_id']:'';?></td>
                          <td>
